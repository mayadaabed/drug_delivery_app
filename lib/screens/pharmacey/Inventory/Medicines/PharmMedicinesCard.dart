              ...
              child: Column(
                ...
                children: [
                    ...
                    onToggle: (value) {
                      setState(() {
                        ...
                        widget.avalibilty == '1'
                            ...
                            : updateProductAvailability('1', widget.id);
                        // updateProductAvailability('0', widget.id);
                      });
                    },
                  ),
                  ElevatedButton.icon(
                    ...
                    label:
                        Text('delete'.tr, style: TextStyle(color: mainColor)),
                    style: ElevatedButton.styleFrom(
                        textStyle: TextStyle(fontSize: 12), primary: white),
                  ),
                ],
              ),
            )
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Confirm delete order'),
          actions: [
            TextButton(
              onPressed: () {
