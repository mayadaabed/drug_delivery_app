                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      child: Badge(
                        showBadge: appGet.notificationcounts.string
                                .toString()
                                .isNotEmpty
                            ? true
                            : false,
                          ...
                          return InkWell(
                              onTap: () {
                                Get.to(() => OrderDetailsPage(
                                    ...
                                    snapshot.data!.docs[index]['userFcm']));
                              },
                              child: Padding(
                                  padding: EdgeInsets.only(
                                    left: 8.w,
                                  ...
                                  child: AllOederCard(
                                    ...
                                    snapshot.data!.docs[index]['address']
                                        .toString(),
                                    '${DateTime.fromMicrosecondsSinceEpoch(snapshot.data!.docs[index]['deliveryDate'] * 1000).day} ${DateTime.fromMicrosecondsSinceEpoch(snapshot.data!.docs[index]['deliveryDate'] * 1000).month} ${DateTime.fromMicrosecondsSinceEpoch(snapshot.data!.docs[index]['deliveryDate'] * 1000).year}',
                                    snapshot.data!.docs[index]['pharmId']
                                        .toString(),
                                    snapshot.data!.docs[index]['items'],
